...
<?php }else{}?>
  ...
  <td style='border:solid black 1.0pt;'>
    ...
    <input type="hidden" name="id_laporanharian<?=$no;?>" value="<?= $mon['id_laporanharian'];?>" >
        <input type="number" name="modal<?=$no;?>" value="<?= $mon['modal'];?>" >
  </td>
  <?php if($i == 1){?>
  <td style='border:solid black 1.0pt;'rowspan="4">
        <input type="hidden" name="income" value="<?= $edit['income'];?>" ><?= $edit['income'];?>
  </td>
  <?php }else{}?>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="kantorplus<?=$no;?>" value="<?= $mon['kantorplus'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="text" name="keterangan<?=$no;?>" value="<?= $mon['keterangan'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="text" name="bon<?=$no;?>" value="<?= $mon['bon'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="qris<?=$no;?>" value="<?= $mon['qris'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="man<?=$no;?>" value="<?= $mon['man'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="bca<?=$no;?>" value="<?= $mon['bca'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="bpd<?=$no;?>" value="<?= $mon['bpd'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="bri<?=$no;?>" value="<?= $mon['bri'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="dll<?=$no;?>" value="<?= $mon['dll'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
        <input type="number" name="kantorminus<?=$no;?>" value="<?= $mon['kantorminus'];?>" >
  </td>
  <td style='border:solid black 1.0pt;'>
