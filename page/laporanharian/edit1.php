...
{   
  ...
  for($i=1; $i<=$total; $i++)
  {
    ...
    $ongkir = str_replace(".","",$_POST["ongkir$i"]);         
...
?>
 ...
 <table class="table" cellspacing="0">
                                 ...
                                 <tr>
                                  ...
                                  <th><input type='text' class=''name='alamatorderan1'></th> 
                                  <th>
                                  ...
                                  <th><input type='text' class='' name='ongkir1'onkeydown='return numbersonly(this, event);' onkeyup='javascript:tandaPemisahTitik(this);'></th>
        ...
        $("#btn-tambah-form").click(function(){ // Ketika tombol Tambah Data Form di klik
            ...
            $("#insert-form").append(
                ...
                "<tr>"+
                                  ...
                                  "<th><input type='text' class=''name='alamatorderan" + nextform + "'></th> "+
                                  "<th>"+
                                  ...
                                  "<th><input type='text' class='' name='ongkir" + nextform + "' onkeydown='return numbersonly(this, event);' onkeyup='javascript:tandaPemisahTitik(this);'></th>"+
