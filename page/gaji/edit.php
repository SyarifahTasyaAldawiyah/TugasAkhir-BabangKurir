    ...
    <?php  if(isset($_GET['id'])){
        $sql_cek = "SELECT * FROM level_driver  WHERE  id_level='".$_GET['id']."'";
                                 ...
                                 <tr>
                                    ...
                                    <td width="50%">
                                        <input type="text" name="persentase" class="form-control" id="exampleLastName"
                                            value="<?= $data_cek['persentase'];?>" required><p></p>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td width="5%"></td>
...
if (isset($_POST['simpan'])){
    ...
    $koneksi->query("UPDATE level_driver SET 
                    nama_level     = '$_POST[nama_level]',
                    persentase = '$_POST[persentase]'
                    WHERE id_level = '$_POST[id]'");
echo"<script>alert('Data Berhasil di Ubah!!!'); window.location = '?page=page/level_driver/index&id=Data Level Driver'</script>";
    }
